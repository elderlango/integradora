...
export default StyleSheet.create({
  ...
  featureCard: {
    ...
    padding: 10,
    borderRadius: 10,
    backgroundColor: '#CCBD9E', // Fondo de las tarjetas de características
    alignItems: 'center',
    justifyContent: 'center',
    elevation: 3,
    shadowColor: '#000',
  ...
  featureCardText: {
    ...
    color: '#F7F6FA', // Color del texto en las tarjetas de características
    textAlign: 'center',
  },
  brandsSection: {
    flexDirection: 'row',
