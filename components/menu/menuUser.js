  ...
  return (
      <View style={MenuStyle.overlay}  onPressIn={() => setMenuVisible(!menuVisible)}>
        ...
        style={activeScreen === 'Nosotros' ? MenuStyle.activeMenuItem: MenuStyle.menuItem}>
            ...
            <TouchableOpacity onPress={() => { navigation.navigate('UserDashboard'); setActiveScreen('UserDashboard'); }} 
        style={activeScreen === 'UserDashboard' ? MenuStyle.activeMenuItem: MenuStyle.menuItem}>
              <Icon name="user-circle" style={{
                ...(activeScreen === 'UserDashboard' ? MenuStyle.activeIcon : MenuStyle.menuIcon),
                ...(theme === 'light' ? MenuStyle.menuIcon : MenuStyle.menuIconDark),
              }}/>
              <Text style={{
